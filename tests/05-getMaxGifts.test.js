...
const getMaxGifts = (giftsCities, maxGifts, maxCities) => {
    if (!Array.isArray(giftsCities) && typeof maxGifts !== "number" && typeof maxCities !== "number") throw new Error("Invalid Param");
    ...
    if (giftsCities.some(gift => typeof gift !== "number")) throw new Error("Invalid Param");
