...
navideños. El primer adorno que quieren fabricar es un cubo que se pone en 
los árboles.

El problema es que tienen que programar la máquina y no saben cómo 
hacerlo. Nos han pedido ayuda para lograrlo.

Para crear los cubos se le pasa un número con el tamaño deseado al 
programa y este devuelve un string con el diseño de ese tamaño. 
...
export const createCube = (size) => {
    if (typeof size !== "number" || size < 1) throw new Error("Invalid Param");
    const top = [];
    const bottom = [];
